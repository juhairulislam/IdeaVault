        ...
        <div className="flex items-center justify-between gap-4 mb-4 text-xs">
          ...
          <div className="flex items-center gap-2 min-w-0">
            {author?.photoURL ? (
              ...
              <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-slate-100 text-slate-600 dark:bg-zinc-800 dark:text-zinc-400">
                <BiUser className="h-3.5 w-3.5" />
              </div>
            )}
            <span className="font-semibold text-slate-700 truncate dark:text-zinc-300">
          ...
          <div className="flex items-center gap-1 shrink-0 text-slate-500 dark:text-zinc-400">
            <BiCalendar className="h-3.5 w-3.5 text-slate-400 dark:text-zinc-500" />
